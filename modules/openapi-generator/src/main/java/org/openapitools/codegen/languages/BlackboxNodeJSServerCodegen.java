...
public class BlackboxNodeJSServerCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public BlackboxNodeJSServerCodegen() {
        super();

        // set the output folder here
        outputFolder = "generated-code/blackbox-nodejs";
         ...
         */
        embeddedTemplateDir = templateDir = "blackboxnodejs";
